...
class Cell:
    ...
    def __truediv__(self, other):
        return round(self.number_cells / other.number_cells)

    def make_order(self, cell, number_cells_row):
        str_cell = ''
        for i in range(1, cell.number_cells + 1):
            str_cell += '*'
            if i % number_cells_row == 0:
                str_cell += '\n'
        return str_cell


my_cell = Cell(50)
print(my_cell + Cell(30))
print(my_cell - Cell(30))
print(my_cell * Cell(30))
print(my_cell / Cell(30))
print(my_cell.make_order(my_cell, 8))